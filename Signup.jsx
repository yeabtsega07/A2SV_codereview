    ...
    <div className="w-screen h-screen mb-10 flex justify-center items-center">
      <div className="bg-[#2a464fc8] text-white rounded-2xl shadow-2xl flex flex-col w-full pt-12 md:w-1/2 h-5/6 items-center max-w-4xl transition duration-1000 ease-in">
        ...
        >
          ...
          <button
            type="submit"
            className="rounded-2xl m-4 text-[#16353cec] font-medium bg-white w-3/5 px-4 py-2 shadow-md hover:text-white hover:bg-[#255f6bec] transition duration-200 ease-in"
          >
            Sign Up
          </button>
          {error && (
            <span className="my-2 text-[#c29191]">Something went wrong!</span>
          )}
        </form>
        <div className="inline-block border-[1px] justify-center w-20 border-white border-solid"></div>
